...
import { UserCheck, GraduationCap, KeyRound } from 'lucide-react';
      ...
      <div className="w-full max-w-md p-6">
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <img src="/gist-logo.png" alt="GIST Logo" className="h-16 w-16" />
          </div>
          <h1 className="text-3xl font-bold text-foreground">GIST Exam</h1>
          <p className="text-muted-foreground mt-2">Global Institute of Science & Technology</p>
        </div>
